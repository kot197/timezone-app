...
export default function Modal({ children, isOpen, onClose }: { children: React.ReactNode, isOpen: boolean, onClose: () => void }) {
    ...
    return (
        ...
        <div className="flex items-center justify-center fixed w-full h-full top-0 left-0">
            {/* Modal */}
            <div className="bg-transparent rounded-3xl border-2 border-white backdrop-blur-sm w-1/4 shadow-md flex justify-center items-center p-10 overflow-hidden transition-[height] duration-500 ease-in-out">
