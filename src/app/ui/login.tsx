...
import { handleSignIn } from '../api/auth/actions';
...
export default function Login() {
    ...
    return (
        <div className="w-full flex flex-col items-center">
            ...
            <form className="w-full h-full flex flex-col" action={handleSignIn}>
                ...
                <button type="submit" className="py-2 px-4 rounded-3xl bg-white hover:bg-gray-600 transition-all mt-4 text-black hover:text-white">
